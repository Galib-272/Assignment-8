          ...
          <div className="grid md:grid-cols-2 gap-8 text-left">
            ...
            >
              ...
              <p className="text-blue-50 italic">
                Active recall and spaced repetition are your best friends when
                learning code.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-blue-50 italic">
                Use the Pomodoro technique: 25 mins work, 5 mins break to keep
                your mind fresh.
              </p>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="max-w-md text-center md:text-left mb-8 md:mb-0">
              ...
              <p className="text-gray-400 text-lg">
                Master AI, Data Science, and Cyber Security with our updated
                2026 curriculum.
              </p>
            </div>
